...
@WebServlet("/course_professional")
public class S_CourseProfessional extends AbstractServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Course> courseList = cdb.retrieveCourseByData("course_category", "professional", "active");
